define([
  ...
  module.service('deployAnnotationsSrv', function ($rootScope, $q, datasourceSrv, alertSrv, timeSrv) {
    var promiseCached;
    var list = [];
    var self = this;
    ...
    this.injectDeployAnnotations = function (dashboard) {
      var annotationsList = dashboard.annotations.list;
      if (annotationsList.some(function (an) {
          return an.deployTag;
        })) {
        return;
      }
